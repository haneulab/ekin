import { type Jean } from '@application/types'
import { v4 as uuid } from 'uuid'
const Jeans: Jean<['new&featured', 'stagefit', 'performance', 'simplistic']>[] =
    [
        {
            id: uuid(),
            name: 'Helenish',
...
const JeansCategories = Object.values(Jeans.map((e) => e.category))

export { Jeans, JeansCategories }
